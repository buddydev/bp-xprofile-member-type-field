...
class BD_Xprofile_Member_Type_Field_Helper {
	 ...
	 * Track shown fields.
	 *
	 * Hack to make it work with older version of themes.
	 *
	 * @var array
	 */
	...
	/**
	 * Register our filed type.
	 *
	 * @param array $filed_types field types.
	 *
	 * @return array
	 */
	public function add_field_types( $filed_types ) {

		// you may be wondering why I am using array instead of $filed_types['membertype'] = 'class name'.
		// Just for future updates to add more field types.
	 ...
	 *
	 * @param Object $data_field data field.
	 */
